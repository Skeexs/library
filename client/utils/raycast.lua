-- FROM https://github.com/freamee/Serverside-ObjectController/blob/a755c0e2d15f4ef2b5f4ed8d9089f771d7298f33/client/cl_w2s.lua
...
function s2w(cam, camPos, relX, relY)
...
function screenToWorld(cam, flags, ignore)
    ...
    local target = s2w(cam, camPos, processedCoords.x, processedCoords.y)
    ...
    local ray = StartShapeTestLosProbe(from.x, from.y, from.z, to.x, to.y, to.z, flags, ignore, 0)
